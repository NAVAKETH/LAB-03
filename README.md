...
###เราสามารถแท็กข้อมูลการคลิ๊กในโปรแกรมเป็นแกนXและYได้และสามารถเช็คเมาส์ที่กดได้ว่าเป็นเมาส์ซ้ายหรือขวา ดังรูป

![](https://github.com/NAVAKETH/LAB-03/blob/master/4.1.PNG?raw=true)
![](https://github.com/NAVAKETH/LAB-03/blob/master/4.PNG)
